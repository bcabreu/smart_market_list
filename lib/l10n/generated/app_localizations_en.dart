...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get uploadSuccess => 'Photo updated successfully!';
  ...
  String get termsOfUseText =>
      'Last updated: January 02, 2026\n\n1. Acceptance of Terms\nBy accessing or using Smart Market List (the App), you agree to these Terms of Use. If you do not agree, do not use the App.\n\n2. What the App does\nSmart Market List is a shopping organization app that lets you create lists, manage items, quantities and costs, and use features such as categories and other tools to improve your routine.\n\n3. Account and Responsibilities\n• You are responsible for the information you add to the App (lists, items, prices, notes, etc.).\n• You must keep your access and device secure.\n• You agree to use the App lawfully and in compliance with these Terms.\n\n4. Subscriptions, In-App Purchases and Payments\nThe App may offer paid features (Pro, monthly/yearly subscription, ad removal, cloud sync, etc.). All transactions are processed by the app stores (Google Play / App Store) and/or providers (e.g., RevenueCat). We do not store your credit card details.\n• Cancellation: you can cancel anytime via your store settings.\n• Restore purchases: when available, use the Restore purchases option in the App.\n• Refunds: subject to the policies of the store where the purchase was made.\n\n5. Advertising\nThe free version may display ads. To keep the app free, we may use third-party ad networks (e.g., AdMob) and device advertising identifiers, depending on your preferences and system permissions.\n\n6. Third-Party Services\nWe may use third-party services to operate and improve the App (e.g., authentication, cloud, analytics, ads and purchases). Your use of these services is subject to the providers\' policies.\n\n7. Prohibited Use\n• Attempting to bypass security, exploit vulnerabilities, or disrupt the App.\n• Copying, modifying, reselling, distributing, or exploiting the App without permission.\n• Using bots/automation that overload the service.\n• Using the App for unlawful activities.\n\n8. Availability and Changes\nWe may update, change, suspend, or discontinue features at any time for maintenance, improvements, security, or legal requirements.\n\n9. Disclaimer of Warranties\nThe App is provided as is and as available. We do not guarantee error-free or uninterrupted operation, or full compatibility with all devices.\n\n10. Limitation of Liability\nTo the maximum extent permitted by law, we are not liable for indirect damages, data loss, lost profits, or failures caused by third-party services, internet connectivity, stores, or external providers.\n\n11. Privacy\nPersonal data handling is described in our Privacy Policy.\n\n12. Updates to These Terms\nWe may update these Terms from time to time. The Last updated date reflects the latest version. Continued use of the App after changes means you accept the updated Terms.\n\n13. Contact\nQuestions? Contact us at:\nEmail: contato@kepoweb.com';
}
