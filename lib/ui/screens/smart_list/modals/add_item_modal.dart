...
class _AddItemModalState extends ConsumerState<AddItemModal> {
  ...
  void initState() {
    ...
    _priceController =
        TextEditingController(); // Filled in didChangeDependencies
  ...
  Future<void> _submit() async {
    if (_nameController.text.trim().isNotEmpty) {
      final itemName = formatItemName(_nameController.text);
      ...
      if (!isPremium) {
        ...
        if (showPaywall) {
          ...
          AdService.instance.checkItemAdTrigger(
            onContinue: () {
              completeAdd();
  ...
  bool _isSystemItem(String? name) {
    ...
    return ProductCatalog.getItems(
      languageCode,
    ).any((item) => item.name.trim().toLowerCase() == cleanName);
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Autocomplete<ProductSuggestion>(
                      ...
                      displayStringForOption: (ProductSuggestion option) =>
                          option.name,
                      ...
                      fieldViewBuilder:
                          (context, controller, focusNode, onFieldSubmitted) {
                            ...
                            return TextField(
                              ...
                              enabled:
                                  widget.itemToEdit == null || !isSystemItem,
                              style: TextStyle(
                                color:
                                    (widget.itemToEdit != null && isSystemItem)
                      ...
                      optionsViewBuilder: (context, onSelected, options) {
                        final hiddenSuggestions = ref.watch(
                          hiddenSuggestionsProvider,
                        );
                        final hiddenSet = hiddenSuggestions
                            .map((e) => e.toLowerCase())
                            .toSet();
                        final visibleOptions = options
                            .where(
                              (o) => !hiddenSet.contains(o.name.toLowerCase()),
                            )
                            .toList();
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        final ProductSuggestion option =
                                            visibleOptions.elementAt(index);
                                        final isSystem = _isSystemItem(
                                          option.name,
                                        );
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: _inputDecoration(
                              locale.languageCode == 'pt' ? '0,00' : '0.00',
                              isDark,
                            ),
                            onChanged: (value) =>
                          ...
                          onTap: () {
                            ...
                            showMenu<String>(
                              ...
                              position: position.shift(
                                const Offset(24, 460),
                              ), // Adjust position to align with field
                              ...
                              items: [
                                ...categories.map((cat) {
                                  ...
                                  final isDefault = AppColors.categoryGradients
                                      .containsKey(cat);
  ...
  String _getLocalizedCategoryName(String category, AppLocalizations l10n) {
    switch (category.toLowerCase()) {
      case 'hortifruti':
        return l10n.cat_hortifruti;
      case 'padaria':
        return l10n.cat_padaria;
      case 'laticinios':
        return l10n.cat_laticinios;
      case 'acougue':
        return l10n.cat_acougue;
      case 'mercearia':
        return l10n.cat_mercearia;
      case 'bebidas':
        return l10n.cat_bebidas;
      case 'limpeza':
        return l10n.cat_limpeza;
      case 'higiene':
        return l10n.cat_higiene;
      case 'congelados':
        return l10n.cat_congelados;
      case 'doces':
        return l10n.cat_doces;
      case 'pet':
        return l10n.cat_pet;
      case 'bebe':
        return l10n.cat_bebe;
      case 'utilidades':
        return l10n.cat_utilidades;
      case 'outros':
        return l10n.cat_outros;
      default:
