...
void main() async {
  ...
  // If SharedPreferences is empty (app reinstalled), but Firebase has a user (Keychain), 
  // we must logout to enforce "Guest" state.
  final prefs = await SharedPreferences.getInstance();
  final hasRunBefore = prefs.getBool('has_run_before') ?? false;

  if (!hasRunBefore) {
    print('✨ Fresh Install Detected! Clearing any lingering auth sessions...');
